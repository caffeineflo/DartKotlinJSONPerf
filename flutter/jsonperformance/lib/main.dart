...
import 'package:jsonperformance/airports.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: "JSON Benchmark"),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _parseJSON() async {
    ...
    airportFromJson(jsonStr);
    stopwatch.stop();
    final executionTime = stopwatch.elapsedMilliseconds;
    stopwatch.reset();
    print('JSON parser executed in ${executionTime}');
